...
{
    #ifdef UART_ISR_INTERRUPT_INTERRUPT_CALLBACK
        UART_ISR_Interrupt_InterruptCallback();
    #endif /* UART_ISR_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling UART_ISR_Start or UART_ISR_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after UART_ISR_Start or UART_ISR_StartEx has been called. 
