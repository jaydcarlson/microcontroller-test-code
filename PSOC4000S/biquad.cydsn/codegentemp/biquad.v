// ======================================================================
// biquad.v generated from TopDesign.cysch
// 09/09/2017 at 17:11
...
module top ;
	...
	wire [0:0] tmpOE__Toggle_net;
	wire [0:0] tmpFB_0__Toggle_net;
	wire [0:0] tmpIO_0__Toggle_net;
	wire [0:0] tmpINTERRUPT_0__Toggle_net;
	electrical [0:0] tmpSIOVREF__Toggle_net;

	cy_psoc3_pins_v1_10
		#(.id("1923aacd-92f1-4ee5-a316-d0a88236cbf2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Toggle
		 (.oe(tmpOE__Toggle_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Toggle_net[0:0]}),
		  .io({tmpIO_0__Toggle_net[0:0]}),
		  .siovref(tmpSIOVREF__Toggle_net),
		  .interrupt({tmpINTERRUPT_0__Toggle_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Toggle_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
